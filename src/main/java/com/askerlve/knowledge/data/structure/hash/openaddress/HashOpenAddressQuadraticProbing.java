package com.askerlve.knowledge.data.structure.hash.openaddress;

/**
 * @author Askerlve
 * @Description: 采用开放地址法来编写一个散列表，使用二次探测来解决散列冲突，对空间的浪费更高，以接近50%的空间浪费可以换取速度
 * @date 2019/2/1上午10:31
 */
public class HashOpenAddressQuadraticProbing {
    ...
    public HashOpenAddressQuadraticProbing(int capacity) {
