package com.askerlve.knowledge.data.structure.trie__tree;
...
public class TST<Value> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("keysWithPrefix(\"key\"):");
        for (String s : st.keysWithPrefix("key"))
            System.out.println(s);
        System.out.println();

        System.out.println("keysThatMatch(\"key2\"):");
        for (String s : st.keysThatMatch("key2"))
            System.out.println(s);
    }
}
